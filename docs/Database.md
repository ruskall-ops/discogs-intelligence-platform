...
Schema version 7 is current and is distinct from released application version
0.6.0. Neither the previous v0.5.1 Marketplace Change implementation nor the
released v0.6.0 presentation work adds migration 8.
