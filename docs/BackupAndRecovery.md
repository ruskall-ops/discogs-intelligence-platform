...
version. Schema version 7 and candidate application version 0.6.0 are separate
version identities. The unreleased v0.6.0 candidate adds no migration or backup
format change. DIP v0.5.1 was released on 2 August 2026 and is the latest
